...
BACKGROUND_COLOR_MAP = {
    "kt_studio": (28, 28, 30),
    "white_room": (230, 230, 230),
    "red_gradient": (155, 20, 32),
}
...
def generate_scene_video(
    ...
    try:
        ...
        color = BACKGROUND_COLOR_MAP.get(background, BACKGROUND_COLOR_MAP["kt_studio"])
        clip = ColorClip(size=(1280, 720), color=color, duration=duration_sec)
